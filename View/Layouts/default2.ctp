      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <?php echo $this->Html->image('periclesWeiber.jpg',array('class'=>'user-image','alt'=>'User Image')) ?>
              <span class="hidden-xs">Pericles Weiber</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
              	<?php echo $this->Html->image('periclesWeiber.jpg',array('class'=>'img-circle','alt'=>'User Image')) ?>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">Menu</li>
            <li><a href="/cakephp/Psicologos/edit/$id"><i class="fa fa-user-o"></i> Editar conta</a></li>
