    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">Menu</li>
            <li><a href="/cakephp/Psicologos/edit/2"><i class="fa fa-user-o"></i> Editar conta</a></li>

        </li>
          <li><a href="/cakephp/horarios"><i class="fa fa-calendar"></i> Horarios</a></li>
        </li>
				<!-- segundo menu 
        <li class="treeview">
          <a href="#">
        ...
        !-->
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/cakephp/Documentos/index"><i class="fa fa-circle-o"></i> Listar Documentos</a></li>
            <li><a href="/cakephp/Documentos/upload"><i class="fa fa-circle-o"></i> Upload de Documentos</a></li>
          </ul>
        </li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/cakephp/psicologos/validar"><i class="fa fa-check-circle"></i> Validar psicoterapeuta</a></li>
            <li><a href="/cakephp/psicologos"><i class="fa fa-th-list"></i>Listar psicoterapeuta</a></li>
            <li><a href="/cakephp/clientes"><i class="fa fa-th-list"></i>Listar clientes</a></li>
          </ul>
        </li>
