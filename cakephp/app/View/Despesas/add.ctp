...
<div class="col-md-6">
          ...
          <form action="/cakephp/despesas/add" id="DespesaAddForm" method="post" accept-charset="utf-8">
              ...
              <div class="form-group">
                  <div class="input text">
                      <div class="col-md-2">
                          <label for="DespesaIsEntrada">Entrada de dinheiro?</label>
                      </div>
                      <div class="col-md-10">
    ...
    <div class="row">
          <div class="form-group">
            <div class="input text">
                <div class="col-md-2">
                  <label for="DespesaIsPaga">Está Paga?</label>
                </div>
                <div class="col-md-10">
    ...
    <div class="row">
            <div class="form-group">
                <div class="input text">
                    ...
                    <div class="col-md-10">
                      <?php echo $this->Form->input('Despesa][tipo_Despesa', array('options' => array("Individual", "Grupo"),'empty' => '(escolha um)','label'=>false,'class'=>'form-control'));?>
                    </div>
                </div>
            </div>
    </div>
